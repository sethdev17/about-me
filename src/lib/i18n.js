...
// Setează data of birth-ului tău (YYYY-MM-DD)
const BIRTHDATE = "2006-01-31"; // Schimbă cu data ta de naștere
...
// Funcție pentru a obține anul curent
function getCurrentYear() {
  return new Date().getFullYear();
}

// Funcție pentru a genera traducerile cu valori dinamice
export function getTranslations() {
  ...
  return {
    ro: {
      ...
      ageText: `${currentAge} Ani`,
      bio: `
      <p>Salut! Sunt un dezvoltator la început de drum în vârstă de ${currentAge} ani, captivat de procesul de a transforma idei creative și unice la realitate prin intermediul liniilor de cod. Poate te întrebi, oare ce m-a făcut să mă captiveze acest domeniu?</p>
      <p>Păi totul a început anul trecut, în 2024, pe Discord, când am început să mă intereseze cum sunt făcuți boții de pe această platformă. După ce am aflat prin ce mod sunt făcuți, cum funcționează și cum îi aduci la viață, m-am apucat și eu să-mi fac unul, numit <span class="saber">Saber</span>, care a împlinit deja mai mult de un an.</p>
    ...
    `,
      learningTitle: "Tehnologii pe care le învăț în prezent:",
      percentagePrefix: "Cunoștințe",
    ...
    en: {
      ...
      ageText: `${currentAge} Years`,
      bio: `
      <p>Hey! I'm a ${currentAge}-year-old developer at the start of my journey, captivated by the process of turning creative and unique ideas into reality through lines of code. You might wonder, what made this field captivate me?</p>
      <p>Well, it all started last year, in 2024, on Discord, when I became interested in how bots on this platform are made. After finding out how they are created, how they work, and how to bring them to life, I started making my own, named <span class="saber">Saber</span>, which has already been more than a year old.</p>
    ...
    `,
      learningTitle: "Technologies I am currently learning:",
      percentagePrefix: "Knowledge of",
...
// Pentru compatibilitate cu codul existent, creează o variabilă care se actualizează
let currentTranslations = getTranslations();

export const translations = currentTranslations;

// Actualizează traducerile la schimbarea limbii
export function refreshTranslations() {
  currentTranslations = getTranslations();
