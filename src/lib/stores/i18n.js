...
import { language } from '$lib/stores.js'; // Import the existing language store
...
// Create a derived store `t` that reacts to changes in the `language` store
// and provides the correct translation object.
export const t = derived(language, ($language) => {
    return translations[$language] || translations.ro; // Fallback to Romanian if language is not found
});

// Also export the language store for convenience
export { language };
